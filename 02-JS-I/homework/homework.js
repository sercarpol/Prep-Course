...
function multiplica(x, y) { return x * y // Multiplica "x" por "y" y devuelve el valor
  // Tu código:
...
function esPositivo(numero) { if(numero > 0 ) {return "Es positivo" ; } else if(numero < 0 ) {return "Es negativo" ;}
else return false;
...
function esVocal(letra) { switch(letra) {
  case "a":
  return "Es vocal";
    break;
   case "e": 
